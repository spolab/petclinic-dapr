...
func TestVetLoadOk(t *testing.T) {
	...
	registered.SetType(EventVetRegisteredV1)
...
func TestRegisterVetOk(t *testing.T) {
	...
	//
	registered := event.CloudEvent("vet", EventVetRegisteredV1, &event.VetRegistered{Id: vetId, Name: "name", Surname: "surname", Phone: "phone", Email: "mail@mail.com"})
	//
	// Execute the request
	//
